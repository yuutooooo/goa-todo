...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Create", "POST", "/users/{user_id}/todos"},
			{"List", "GET", "/users/{user_id}/todos"},
			{"Get", "GET", "/users/{user_id}/todos/{todo_id}"},
			{"Update", "PUT", "/users/{user_id}/todos/{todo_id}"},
			{"Delete", "DELETE", "/users/{user_id}/todos/{todo_id}"},
		},
...
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/users/{user_id}/todos", f)
}
...
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/users/{user_id}/todos", f)
}
...
func MountGetHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/users/{user_id}/todos/{todo_id}", f)
}
...
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/users/{user_id}/todos/{todo_id}", f)
}
...
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/users/{user_id}/todos/{todo_id}", f)
}
